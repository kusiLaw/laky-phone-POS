...
class Ui_RightColumn(object):
    def setupUi(self, RightColumn):
        ...
        self.frame_2.setMinimumSize(QSize(210, 170))
        self.frame_2.setMaximumSize(QSize(280, 180))
        ...
        self.frame_13.setMaximumSize(QSize(210, 16777215))
        self.frame_13.setFrameShape(QFrame.NoFrame)
        self.frame_13.setFrameShadow(QFrame.Raised)
        self.pro_pic_frame = QHBoxLayout(self.frame_13)
        ...
        self.reset_password_frame.setContentsMargins(0, 0, 0, 0)
    ...
    def retranslateUi(self, RightColumn):
        ...
        self.label_2.setText(QCoreApplication.translate("RightColumn", u"Lawrence", None))
        self.label_5.setText(QCoreApplication.translate("RightColumn", u"Last seen:", None))
        self.label_6.setText(QCoreApplication.translate("RightColumn", u"2020/03/03 09:30pm", None))
        self.groupBox.setTitle(QCoreApplication.translate("RightColumn", u"change password", None))
        self.label_7.setText(QCoreApplication.translate("RightColumn", u"Current Password:", None))
