...
class Ui_MainPages(object):
    def setupUi(self, MainPages):
        ...
        self.footer.setStyleSheet(u"/**background:rgb(255, 71, 160)")
        self.footer.setFrameShape(QFrame.NoFrame)
        self.footer.setFrameShadow(QFrame.Raised)
        self.verticalLayout_32 = QVBoxLayout(self.footer)
        self.verticalLayout_32.setObjectName(u"verticalLayout_32")
        self.label_41 = QLabel(self.footer)
...
"text-shadow: 0 15px 40px rgba(0,0,0, 0.6);")
        ...
        self.service_page.setFont(font3)
...
"")
        ...
        self.stockContents.setFont(font3)
